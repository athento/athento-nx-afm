...
- Added listener GeneralEventListener to scheduler and listener.
- Ingore sudo into lsof to load file.
- Change package to org.athento
-

Version 2.3.1:

Tarea: http://redmine.yerbabuena.es/issues/45005
	- Added a new event: capturedDocument
	- Fired "capturedDocument" when file is created into DM.
	- Passed as parameter to the Event Context the path where the file was taken from
	- Added default value "false" for property AFM.UpVersion
	- Added a new dependency to AthentoNXUtils component (to manage events firing).